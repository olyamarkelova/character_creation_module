...
def attack(char_name: str, char_class: str) -> str:
    """Выводит результат атаки персонажа в зависимости от класса."""
...
def defence(char_name: str, char_class: str) -> str:
    """Выводит результат защиты персонажа в зависимости от класса."""
    if char_class == 'warrior':
...
def special(char_name: str, char_class: str) -> str:
    """Выводит результат применения специального умения персонажа."""
    if char_class == 'warrior':
        return (
...
def start_training(char_name: str, char_class: str) -> str:
    """Выполняет команды персонажа (атака/защита/специальные умения)."""
    if char_class == 'warrior':
